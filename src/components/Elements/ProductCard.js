...
export const ProductCard = ({ product }) => {
    ...
    return (
        <div className="m-3 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 flex flex-col">
            ...
            <div className="p-5 flex flex-col flex-grow">
                ...
                <p className="mb-3 font-normal text-gray-700 dark:text-gray-400 flex-grow">{overview}</p>
